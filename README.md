...
| :---: | :---: |
| ![BizView Dashboard Screenshot]([https://github.com/tabarakmukhtar/BizView/blob/main/screenshorts/dashboard.png])
| ![BizView Client Management Screenshot](./screenshots/client-management.png) |
